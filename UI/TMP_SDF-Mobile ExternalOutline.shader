...
Shader "TextMeshPro/Mobile/Distance Field External Outline"
{
    ...
    Properties
    {
        ...
        [Enum(CullMode)]_CullMode ("Cull Mode", Float) = 15
    }
    ...
    pixel_t VertShaderOutlined(vertex_t input, float outlineScale)
    {
        ...
        output.param = half4(scale, bias - outline * outlineScale, bias, bias);
